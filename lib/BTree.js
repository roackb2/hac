...
BTree.prototype = {
	...
	conditionalPreOrderTraverse: function(callback, condition) {
		this._conditionalPreOrderTraverse(this.root, callback, condition);
	},
	...
	_conditionalPreOrderTraverse: function(node, callback, condition) {
		if(condition == undefined) {
			condition = function() {return true;};
		}
		callback(node);
		if(node.left && condition(node.left)) {
			this._conditionalPreOrderTraverse(node.left, callback, condition);
		}
		if(node.right && condition(node.right)) {
			this._conditionalPreOrderTraverse(node.right, callback, condition);
		}
		return;
	},
