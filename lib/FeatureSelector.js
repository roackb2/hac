...
FeatureSelector.LLR = function(nTotal, n1i, ni1, n0i, ni0, n11, n10, n01, n00) {
	var numerator = Math.pow(ni1/nTotal, n11) * Math.pow(1 - ni1/nTotal, n10) * Math.pow(ni1/nTotal, n01) * Math.pow(1 - ni1/nTotal, n00);
	var denominator =  Math.pow(n11/n1i, n11) *  Math.pow(1 - n11/n1i, n10) * Math.pow(n01/n0i, n01) * Math.pow(1 - n01/n0i, n00);
